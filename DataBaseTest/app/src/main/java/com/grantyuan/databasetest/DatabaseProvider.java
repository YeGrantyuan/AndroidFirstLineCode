...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.grantyuan.databasetest.provider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case BOOK_DIR:
                return "vnd.android,cursor.dir/vnd.com.grantyuan.databasetest.provider.book";
            case BOOK_ITEM:
                return "vnd.android,cursor.item/vnd.com.grantyuan.databasetest.provider.book";
            case CATEGORY_DIR:
                return "vnd.android,cursor.dir/vnd.com.grantyuan.databasetest.provider.category";
            case CATEGORY_ITEM:
                return "vnd.android,cursor.item/vnd.com.grantyuan.databasetest.provider.category";
        }
        return null;
    }
